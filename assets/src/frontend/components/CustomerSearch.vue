<template>
    ...
    >
        <form action="" autocomplete="off">
            ...
            />
            <span
                class="add-new-customer flaticon-add"
...
export default {
        ...
        "orderdata.customer_id"(newVal) {
            this.serachInput = newVal
                ? this.orderdata.billing.first_name +
                  " " +
                  this.orderdata.billing.last_name
                : "";
        },
    },
    ...
    methods: {
        ...
        onKeyDown() {
            jQuery(".customer-search-item.selected")
                .next()
                .children("a")
                .focus();
        },
        ...
        createCustomer() {
            if (this.customer.email) {
                ...
                wepos.api
                    .post(
                        wepos.rest.root + wepos.rest.posversion + "/customers",
                        customerData
                    )
                    .done((response) => {
                        this.serachInput =
