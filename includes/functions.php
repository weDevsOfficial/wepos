 ...
 * @return void
 */
function wepos_get_template( $template_name, $args = [], $template_path = '', $default_path = '' ) {
    ...
    do_action( 'wepos_before_template_part', $template_name, $template_path, $located, $args );

    include $located;

    do_action( 'wepos_after_template_part', $template_name, $template_path, $located, $args );
}
 ...
 *
 *      your-theme        /   $template_path  /   $template_name
 *      your-theme       /   $template_name
 ...
 * @return string
 */
function wepos_locate_template( $template_name, $template_path = '', $default_path = '' ) {
    if ( ! $template_path ) {
        $template_path = wepos()->template_path();
    }

    if ( ! $default_path ) {
        $default_path = WEPOS_PATH . '/templates/';
    }
    ...
    return apply_filters( 'wepos_locate_template', $template, $template_name, $template_path );
}
